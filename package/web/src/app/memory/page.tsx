              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <Select
                    ...
                    className="max-w-xs"
                  >
                    <SelectItem key="4">4ペア (8枚)</SelectItem>
                    <SelectItem key="6">6ペア (12枚)</SelectItem>
                    <SelectItem key="8">8ペア (16枚)</SelectItem>
                    <SelectItem key="10">10ペア (20枚)</SelectItem>
                  </Select>
                </div>
                <Button
                  color="primary"
